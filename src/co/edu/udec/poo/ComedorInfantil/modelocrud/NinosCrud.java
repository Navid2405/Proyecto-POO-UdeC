...
public class NinosCrud{
    ...
    public  void Agregar(Ninos niño)throws Exception{
        if(!ninos.containsKey(niño.getIdentificacion())){
             ninos.put(niño.getIdentificacion(), niño);
            
        } else {
           throw new Exception ("El niño con la identificacion:" + niño.getIdentificacion()+ "ya se encuentra registrado");
        }
    ...
    public void registrar(String nombre, String NUmMatricula, Date Nacimiento, String Ident){
        Ninos niño= new Ninos(nombre, NUmMatricula, Nacimiento, Ident);
        ninos.put(niño.getIdentificacion(), niño);
    }
