 ...
 * @author Navid Lobato
 */
public class VentanaAsignarPagadore extends javax.swing.JDialog {

    /**
     * Creates new form VentanaAsignarPagadore
     */
    public VentanaAsignarPagadore() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Identificacion Pagador");
    ...
    private void botonAsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAsignarActionPerformed
        ...
        String dniPagador= campDni.getText();

        try {
            AsignarPagadorPeticionDto peticion = new AsignarPagadorPeticionDto(dniPagador, identificacionNino);
            PagadorCrud pcrud = new PagadorCrud();
            AsignarPagadorCasoDeUso cDu = new AsignarPagadorCasoDeUso(pcrud);
            AsignarPagadorControlador controlador = new AsignarPagadorControlador(cDu);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAsignarPagadore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaAsignarPagadore dialog = new VentanaAsignarPagadore();
