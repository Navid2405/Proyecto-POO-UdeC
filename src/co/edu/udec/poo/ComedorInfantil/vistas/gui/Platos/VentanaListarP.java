 ...
 * @author Navid Lobato
 */
public class VentanaListarP extends javax.swing.JDialog {

    /**
     * Creates new form VentanaListarP
     */
    private ListarControladorPlatos controlador;
    public VentanaListarP(ListarControladorPlatos controlador) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaListarP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaListarP dialog = new VentanaListarP(controlador);
